/**
 * Created by thuhang on 06/10/2016.
 */
/*
...
Ext.define('Shared.view.Grid', {
    ...
    downloadExcelXml: function(includeHidden, title) {
        ...
        if (Ext.isChrome) {
            ...
            form = this.add({
                ...
                hidden: true,
                standardSubmit: true,
                url: './ReportDownload.ashx?fileName=' + escape(title + ".xls"),
    ...
    getExcelXml: function(includeHidden, title) {
        ...
        var oddColor = this.downloadConfig.oddRowColor;
        var evenColor = this.downloadConfig.evenRowColor;
        return ''.concat(
        '<?xml version="1.0"?>',
        ...
        '<Style ss:ID="even">',
        '<Interior ss:Color="' + evenColor + '" ss:Pattern="Solid" />',
        '</Style>',
        ...
        '<Style ss:ID="odd">',
        '<Interior ss:Color="' + oddColor + '" ss:Pattern="Solid" />',
        '</Style>',
